...
const QuizAnswer = ({ question, questionNo, ans }) => {
  ...
  return (
    <div className="w-full h-screen flex items-center justify-center fixed top-0 left-0 right-0 bottom-0 bg-slate-500/50">
      <div className="bg-white flex justify-between p-3 rounded-lg w-3/6">
        <div className="p-10 w-full">
          <p className="text-2xl text-indigo-400 mb-10">Quiz {questionNo}. {question}</p>
          <p className="text-indigo-600 text-xl">Ans: {ans}</p>
        </div>
        <XMarkIcon
